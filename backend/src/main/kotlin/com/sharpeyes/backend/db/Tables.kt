package com.sharpeyes.backend.db

import com.sharpeyes.backend.sprites.SPRITE_KEY_LENGTH
...
object Users : Table("users") {
    ...
    // lens until this is answered, so it refuses to answer rather than picking one. V74.
